              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-video sm:aspect-square overflow-hidden bg-slate-100">
                    ...
                    {/* Category / Sedekah Badge */}
                    {isSedekah && (
                      <span className="absolute top-3 left-3 bg-gradient-to-r from-amber-500 to-amber-600 text-emerald-950 font-black text-[10px] uppercase px-2.5 py-1 rounded-full shadow-md flex items-center space-x-1">
                    ...
                    {product.isSubsidy && (
                      <span className="absolute top-3 right-3 bg-red-600 text-white font-bold text-[10px] px-2 py-0.5 rounded shadow">
                        Subsidi Kios
                      </span>
                    )}
