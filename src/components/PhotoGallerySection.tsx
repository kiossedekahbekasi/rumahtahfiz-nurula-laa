...
import { HeartHandshake, Sparkles, CheckCircle2, Edit3 } from 'lucide-react';
...
export const PaketSedekahSection: React.FC<PaketSedekahSectionProps> = ({ products, onAddToCart, onEditProduct }) => {
              ...
              <div>
                <div className="relative aspect-video rounded-xl overflow-hidden mb-4 bg-emerald-950">
                  ...
                  <div className="absolute top-2 left-2 right-2 flex items-center justify-between">
                    <span className="bg-amber-400 text-emerald-950 font-black text-[10px] px-2 py-0.5 rounded shadow">
                      Sedekah Utama
                    </span>
                    {onEditProduct && (
                      <button
                        ...
                        className="bg-slate-900/85 hover:bg-amber-400 text-white hover:text-emerald-950 px-2 py-0.5 rounded-lg text-[10px] font-bold shadow transition-all flex items-center space-x-1 border border-slate-700/80"
                        title="Edit Paket Produk ini"
                      >
